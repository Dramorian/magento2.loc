...
namespace Alex\AskQuestion\Plugin\Catalog\Model\ResourceModel\Product;
...
class Collection
{
     ...
     * @return void
     */
    public function beforeLoad(ProductCollection $subject, bool $printQuery = false, bool $logQuery = false): void
    {
     ...
     */
    public function aroundLoad(ProductCollection $subject, Closure $proceed, bool $printQuery = false, bool $logQuery = false)
    {
