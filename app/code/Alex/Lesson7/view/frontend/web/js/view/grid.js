define(['jquery', 'ko', 'uiComponent',], function ($, ko, component) {
    ...
    return component.extend({
        ...
        availableMeals: ko.observableArray([{mealName: "Standard (sandwich)", price: 5}, {
        ...
        totalSurcharge: function () {
            var total = 0;
            for (var i = 0; i < this.seats().length; i++) total += this.seats()[i].meal().price;
            return total;
        },
